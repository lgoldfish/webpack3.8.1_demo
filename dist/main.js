...
exports.default = {
    "appKey": "82b868b522634f768cc9017f68c7e6c1",
    "mapId": 2874,
    "appId": "wx20c48ba587148439",
    "major": 10173,
    "zoom": 300,
    "zoomMax": 400,
    "zomMin": 100
...
var currentFloorId = void 0,
    floorsData = void 0,
    mapView = void 0,
    camera = void 0,
    dynamicNaviManager = void 0,
    naviMng = void 0;
...
dataSource.requestMaps().then(function (maps) {
    dataSource.requestPOIChildren(maps.list[0].poi).then(function (floors) {
        var floorId = floors[1].id;
        floorsData = floors;
        currentFloorId = floorId;
        dataSource.requestPlanarGraph(floorId).then(function (layerInfo) {
            console.log('layerxxxx ');
            NGR.fetch("/static/json/template.json", {}).then(function (res) {
                return res.json();
            }).then(function (style) {
                ...
                mapView.start();
                new _mapView.AddLight(mapView, styleGenerator).addLight();
                (0, _mapView.zoomLimit)(mapView);
                new _mapView.Control(mapView).compassControl();
            }).catch(function (e) {
...
exports.zoomLimit = exports.AddLight = exports.Control = undefined;
...
var Control = function () {
    ...
    _createClass(Control, [{
        key: 'compassControl',
        value: function compassControl() {
            var _this = this;

            this.mapView.gestureManager.on('rotate', 'rotateEnd', function () {
                var angle = _this.mapView.activeControl.getRotate();
...
var AddLight = function () {
    function AddLight(mapView, styleGenerator) {
        _classCallCheck(this, AddLight);

        this.mapView = mapView;
        this.styleGenerator = styleGenerator;
    }

    _createClass(AddLight, [{
        key: 'addLight',
        value: function addLight() {
            var lightLayer = new NGR.layer.FeatureLayer('light', this.styleGenerator);
            var point = NGR.geom.GeometryFactory.createPoint([0, 300, 300]);
            var lightFeature = new NGR.data.Feature(point, { id: 1 });
...
function zoomLimit(mapView) {
    mapView.activeControl.zoomByFocalLength(_config2.default.zoom);
    mapView.activeControl.maxDistance = _config2.default.zoomMax;
    mapView.activeControl.minDistance = _config2.default.zoomMin;
}
exports.Control = Control;
exports.AddLight = AddLight;
exports.zoomLimit = zoomLimit;
